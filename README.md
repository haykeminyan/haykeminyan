...
```bash
$ cat ~/mission.txt
> Own products end-to-end: architecture, database design, deployment, monitoring.
> Shipped 3 platforms solo — zero to live production traffic.
> Also comfortable in team stacks: FastAPI/Django systems, ML-serving
> microservices routing live requests inside a Kubernetes production stack.

$ ls ~/currently/
> building shoplux.casa (async e-commerce, live)
> learning portuguese  [██████░░░░░░░░░░░░░░] A2
> open-to: remote / hybrid roles, EU-based teams

$ echo $STATUS
> 🟢 available for contract & full-time backend roles
```
...
### 🛒 [ShopLux](https://shoplux.casa)
**shoplux.casa**

Solo-architected async e-commerce platform, still shipping.
...
### 🌍 [TravelCultureHub](https://travelculturehub.com)
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/haykeminyan/haykeminyan/output/github-contribution-grid-snake-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/haykeminyan/haykeminyan/output/github-contribution-grid-snake.svg">
  <img alt="contribution snake" src="https://raw.githubusercontent.com/haykeminyan/haykeminyan/output/github-contribution-grid-snake.svg" width="95%"/>
</picture>

<sub>generated nightly by <code>.github/workflows/snake.yml</code></sub>
...
<sub>generated nightly by <code>.github/workflows/metrics.yml</code></sub>
...
```text
2026 – now     Founder-Engineer · ShopLux           (solo, production)
2025 – 2026    Backend Engineer · DataHatch          (contract)
2025           Founder-Engineer · TravelCultureHub / BareGorc  (solo, production)
2024           Backend Engineer · South Gate Armenia  (contract)
2023 – 2024    Full Stack Engineer · PM Solution
2021 – 2023    Full Stack Engineer · PriceHubble      (FastAPI → K8s ML-serving)
2020 – 2021    Backend Engineer · Realtify
2019 – 2020    Backend Engineer (Trainee) · DataNerds
```

**Education** — Lomonosov Moscow State University, Faculty of Mechanics and Mathematics, Dept. of Mathematical and Computer Methods of Analysis (2014–2020)

**Languages** — 🇬🇧 English (Fluent) · 🇦🇲 Armenian (Native) · 🇷🇺 Russian (Native) · 🇵🇹 Portuguese (A2, learning)
